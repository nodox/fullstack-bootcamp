...
Ok if you haven't done so already go visit the hackernews site (hackernews.com). We are going to build a much better version for this ugly website. I mean come on we are in 2017, and we're still building websites as with not beautiful colors and effects.
