...
Ok if you haven't done so already go visit the hackernews site (https://news.ycombinator.com/). We are going to build a much better version for this ugly website. I mean come on we are in 2017, and we're still building websites as with not beautiful colors and effects. The final product can be found at https://vue-hn.now.sh/top/1. Yes, we are done we are going to have built something you can have pride in when showing your friends and family. 
